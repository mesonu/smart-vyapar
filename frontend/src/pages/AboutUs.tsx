      ...
      <Box component="main" sx={{ flex: 1 }}>
        ...
        >
          <Container maxWidth="lg">
            ...
            >
              Empowering businesses with innovative solutions for growth and
              success
            </Typography>
          </Container>
        </Box>
        ...
        <Container maxWidth="lg" sx={{ py: 8 }}>
          <Grid container spacing={6} alignItems="center">
            <Grid size={{xs:12, sm:6}}>
              ...
              >
                Founded in 2020, SmartShop emerged from a simple vision: to make
                business management accessible and efficient for everyone. What
              ...
              <Typography
                ...
                sx={{ fontSize: "1.1rem", color: "text.secondary" }}
              >
                Today, we serve thousands of businesses across the globe,
                helping them streamline operations, boost productivity, and
                achieve their goals. Our journey is driven by continuous
              ...
              <Grid size={{xs:12, sm:6}}>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ fontSize: "1.1rem", color: "text.secondary" }}
                  >
                    To provide innovative and accessible business management
                    solutions that empower organizations to thrive in the
                    digital age. We strive to simplify complex processes and
                    enable sustainable growth for our clients.
                  </Typography>
                </Paper>
              </Grid>
              <Grid size={{xs:12, sm:6}}>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ fontSize: "1.1rem", color: "text.secondary" }}
                  >
                    To be the global leader in business management solutions,
                    recognized for our innovation, reliability, and commitment
                    to customer success. We envision a world where every
                    business has the tools to reach its full potential.
                  </Typography>
                </Paper>
              </Grid>
            </Grid>
